  ...
  return (
    <div className="w-full max-w-5xl rounded-3xl border border-[#d4a857]/40 bg-transparent p-5 shadow-[0_0_50px_rgba(212,168,87,0.15)] backdrop-blur-xs md:p-8">
      ...
      <div className="mb-6 text-center">
        ...
        {/* Shloka Box */}
        <div className="mx-auto mt-4 max-w-2xl rounded-2xl border border-[#d4a857]/40 bg-transparent p-4 text-center backdrop-blur-xs shadow-[0_0_20px_rgba(212,168,87,0.15)]">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-6">
        {MENTORS_DATA.map((mentor, idx) => (
          <div
            key={idx}
            className="group relative flex flex-col items-center overflow-hidden rounded-2xl border border-[#d4a857]/30 bg-transparent p-5 text-center backdrop-blur-xs transition-all duration-300 hover:border-[#ffe8ad] hover:bg-black/20 hover:shadow-[0_0_35px_rgba(212,168,87,0.35)]"
          >
